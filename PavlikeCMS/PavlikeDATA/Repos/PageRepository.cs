...
namespace PavlikeDATA.Repos
{
    public class PageRepository
    {
        ...
        {
           return _db.Pages.Where(c => c.Active).Include(c => c.Author).OrderBy(c => c.PageOrder).ToList();
        }
        ...
        {
            return _db.Pages.Where(c=> c.Url == url).Include(x=> x.ArticleCollection).Single();
        }
